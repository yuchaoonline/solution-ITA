<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sys_usersedit.aspx.cs" Inherits="mip_pm_sys_usersedit" %>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="97%" valign="bottom">
                                                                <span class="STYLE_HEAD">人员信息编辑</span></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td>
                    ...
                    <td>
                        <table id="Table3" border="0" width="100%" align="center" cellpadding="0" cellspacing="1">
                            ...
                            <tr>
                                ...
                                <td class="STYLE_TABLETD" width="35%">
                                    &nbsp;<asp:TextBox ID="TB_DEPTID" runat="server" Width="35px"></asp:TextBox><asp:TextBox
                                        ID="TB_DEPTNAME" runat="server" Width="105px"></asp:TextBox><asp:Button ID="Bt_DEPARTMENT"
                                            runat="server" OnClick="Bt_DEPARTMENT_Click" Text="选择部门" />
                            ...
                            <tr>
                                ...
                                <td class="STYLE_TABLETD" width="35%">
                                    <asp:TextBox ID="TB_USERREALNAME" runat="server"></asp:TextBox><asp:Label ID="LB_USERREALNAMEunit"
                                        runat="server" Text=""></asp:Label></td>
                                <td class="STYLE_TABLETD" width="15%" align="right">
                            ...
                            <tr>
                                ...
                                <td class="STYLE_TABLETD" width="35%">
                                    <asp:TextBox ID="TB_PASSWORD" runat="server" TextMode="Password"></asp:TextBox><asp:Label
                            ...
                            <tr>
                                ...
                                <td class="STYLE_TABLETD" width="35%">
                                    <asp:TextBox ID="TB_AGE" runat="server" Visible="False"></asp:TextBox><asp:Label
                                        ID="LB_AGEunit" runat="server" Text=""></asp:Label></td>
                                <td class="STYLE_TABLETD" width="15%" align="right">
