<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sys_rolesadd.aspx.cs" Inherits="mip_pm_sys_rolesadd" %>

<%@ Register Assembly="ZLTextBox" Namespace="BaseText" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>角色信息管理页面添加页面</title>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="97%" valign="bottom">
                                                                <span class="STYLE_HEAD">角色信息增加</span></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td>
