...
<asp:ImageButton ID="Imbtn_add" runat="server" ImageUrl="~/Images/image_ch/buttonImages/common/recruit.gif"
            OnClick="Imbtn_add_Click" ToolTip="添加信息标准主码" /></div>
            <br />
    ...
    <asp:GridView ID="GridView1" runat="server" 
                ...
                <Columns>
                     <asp:BoundField HeaderText="序号" DataField="ID" >
                                ...
                                <asp:BoundField HeaderText="编号" DataField="infono" Visible="true">
                                </asp:BoundField>
                                <asp:BoundField HeaderText="信息标准主码名称" DataField="infoname">
                                </asp:BoundField>
