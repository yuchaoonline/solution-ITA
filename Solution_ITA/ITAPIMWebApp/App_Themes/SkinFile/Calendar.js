...
//------------------ 样式定义 ---------------------------//
//功能按钮同样样式
var s_tiannet_turn_base = "height:16px;font-size:9pt;color:white;border:0 solid #CCCCCC;cursor:hand;background-color:#499299;";
//翻年、月等的按钮
...
//日期选择控件体的样式
var s_tiannet_body = "width:150;background-color:#499299;display:none;z-index:9998;position:absolute;" +
  "border-left:1 solid #CCCCCC;border-top:1 solid #CCCCCC;border-right:1 solid #999999;border-bottom:1 solid #999999;";
//显示日的td的样式
var s_tiannet_day = "width:21px;height:20px;background-color:#499299;font-size:10pt;";
//字体样式
var s_tiannet_font = "color:#FFCC00;font-size:9pt;cursor:hand;";
//链接的样式
var s_tiannet_link = "text-decoration:none;font-size:9pt;color:#499299;";
//横线
...
//------------------ 变量定义 ---------------------------//
var tiannetYearSt = 1998;//可选择的开始年份
...
document.write('</select>');
//////////////////////////////////////////////////////
document.write('<span id="tiannetSecHead" Author="tiannet" style="'+s_tiannet_font+'display:true;" '+
    'onclick="spanSecCEvent();">&nbsp;&nbsp;秒</span>');
document.write('<select id="selTianSec" style="'+s_tiannet_select2+'display:none;" Author="tiannet" '+
    '  onChange="tiannetSec=this.value;tiannetWriteHead();document.all.tiannetSecHead.style.display=\'\';'+
    'this.style.display=\'none\';">');
for(var i=0;i <= 59;i ++){
...
document.write(' <tr style="background-color:#499299;font-size:10pt;color:white;height:22px;" Author="tiannet">');
...
function spanYearCEvent(){
 ...
 hideElementsById(new Array("tiannetSecHead"),false);
 hideElementsById(new Array("tiannetYearHead","selTianMonth","selTianHour","selTianMinute","selTianSec"),true);
}
//单击月份span标签响应
function spanMonthCEvent(){
 ...
 if(m_bolShowHour) hideElementsById(new Array("tiannetHourHead"),false);
 if(m_bolShowMinute) hideElementsById(new Array("tiannetMinuteHead"),false);
 hideElementsById(new Array("tiannetSecHead"),false);m_bolShowSec
 hideElementsById(new Array("tiannetMonthHead","selTianYear","selTianHour","selTianMinute","selTianSec"),true);
}
//单击小时span标签响应
function spanHourCEvent(){
 ...
 if(m_bolShowMinute) hideElementsById(new Array("tiannetMinuteHead"),false);
hideElementsById(new Array("tiannetSecHead"),false);
 hideElementsById(new Array("tiannetHourHead","selTianYear","selTianMonth","selTianMinute","selTianSec"),true);
}
//单击分钟span标签响应
function spanMinuteCEvent(){
 ...
 hideElementsById(new Array("tiannetSecHead"),false);
 hideElementsById(new Array("tiannetMinuteHead","selTianYear","selTianMonth","selTianHour","selTianSec"),true);
}
//单击秒span标签响应
function spanSecCEvent(){
 hideElementsById(new Array("tiannetYearHead","tiannetMonthHead"),false);
 if(m_bolShowHour) hideElementsById(new Array("tiannetHourHead"),false);
 if(m_bolShowMinute) hideElementsById(new Array("tiannetMinuteHead"),false);
 hideElementsById(new Array("selTianSec"),false);
 hideElementsById(new Array("tiannetSecHead","selTianMinute","selTianYear","selTianMonth","selTianHour"),true);
}
//根据标签id隐藏或显示标签
...
function tiannetSetValue(bolHideControl){
 ...
 if( m_bolShowMinute ){
  ...
  value += tiannetTimeSplit + minute + tiannetTimeSplit + sec;
 }
 tiannetOutObject.value = value;
...
//dlg.js
function del_mod(url) 
{ 

	window.open (url,'newwindow','height=300,width=800,top=300,left=100,toolbar=yes,menubar=no,scrollbars=yes, resizable=yes,location=no, status=yes') 
