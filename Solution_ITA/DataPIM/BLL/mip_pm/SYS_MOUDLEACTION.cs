...
namespace Mis.BLL.ptgl
{
    ...
    /// <summary>
    /// 业务逻辑类 SYS_MOUDLEACTION 的摘要说明。
    /// </summary>
    public class SYS_MOUDLEACTION
    {
        private static readonly ISYS_MOUDLEACTION dal = DataAccess.CreateSYS_MOUDLEACTION();
        ...
        public Mis.Model.ptgl.SYS_MOUDLEACTION ToLocalData(DataRow row)
        {
            Mis.Model.ptgl.SYS_MOUDLEACTION data = new Mis.Model.ptgl.SYS_MOUDLEACTION();
            data.ID = int.Parse(row["ID"].ToString());
            data.MOUDLENAME = (string)row["MOUDLENAME"].ToString();
            data.ACTION = (string)row["ACTION"].ToString();
        ...
        public Mis.Model.ptgl.SYS_MOUDLEACTION[] ToLocalData(DataTable table)
        {
            Mis.Model.ptgl.SYS_MOUDLEACTION[] userobjs = new Mis.Model.ptgl.SYS_MOUDLEACTION[table.Rows.Count];
        ...
        public Mis.Model.ptgl.SYS_MOUDLEACTION NullToSpace(Mis.Model.ptgl.SYS_MOUDLEACTION item)
        {
